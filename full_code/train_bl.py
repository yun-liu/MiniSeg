...
###############################
# Models without Initialization
###############################
#from models.Baselines import UNet as net
#from models.Baselines import NestedUNet as net
#from models.Baselines import Att_UNet as net
#from models.Baselines import ESPNet as net
#from models.Baselines import EDANet as net
#from models.Baselines import ESPNet as net
#from models.Baselines import ESPNetv2 as net
#from models.Baselines import ENet as net
#from models.Baselines import CGNet as net
#from models.Baselines import SegNet as net
#from models.Baselines import FRRN as net
#from models.Baselines import DenseASPP as net
#from models.Baselines.Others import LEDNet as net
###############################
...
class CrossEntropyLoss2d(nn.Module):
    ...
    def forward(self, *inputs):
        # for [UNet, NestedUNet, Att_UNet, ESPNet, ESPNetv2, EDANet,
...
def main_tr(args, crossVal):
    ...
    # load the model
    model = net.EfficientNet(args.classes, aux=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='EfficientNet', help='Model name')
