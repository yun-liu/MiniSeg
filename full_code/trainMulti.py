...
def main_tr(args, crossVal):
    ...
    max_batches = len(trainLoader) + len(trainLoader_scale3) + len(trainLoader_scale1) + len(trainLoader_scale2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--savedir', default='./results_MiniSeg_crossVal', help='Directory to save the results')#/media/qiuyu/qiuyu/COVID
    ...
    parser.add_argument('--model_name', default='MiniSeg_seed0', help='Model name')
