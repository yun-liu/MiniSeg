...
class DANet(SegBaseModel):
    def __init__(self, classes=2, aux=True, backbone='resnet50', pretrained_base=True):
        super(DANet, self).__init__(classes, aux, backbone, pretrained_base=pretrained_base)
        self.head = _DAHead(2048, classes, aux=False)
...
class _DAHead(nn.Module):
    def __init__(self, in_channels, classes, aux=True):
