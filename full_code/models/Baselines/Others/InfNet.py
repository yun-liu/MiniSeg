...
class InfNet(SegBaseModel):
    def __init__(self, classes=2, aux=False, backbone='resnet50', pretrained_base=True):
        ...
        # ---- Partial Decoder ----
        self.ParDec = aggregation(32, classes)
        # ---- reverse attention branch 4 ----
        self.ra4_conv1 = BasicConv2d(2048, 256, kernel_size=1)
        self.ra4_conv2 = BasicConv2d(256, 256, kernel_size=5, padding=2)
        self.ra4_conv3 = BasicConv2d(256, 256, kernel_size=5, padding=2)
        self.ra4_conv4 = BasicConv2d(256, 256, kernel_size=5, padding=2)
        self.ra4_conv5 = BasicConv2d(256, classes, kernel_size=1)
        # ---- reverse attention branch 3 ----
        self.ra3_conv1 = BasicConv2d(1024, 64, kernel_size=1)
        self.ra3_conv2 = BasicConv2d(64, 64, kernel_size=3, padding=1)
        self.ra3_conv3 = BasicConv2d(64, 64, kernel_size=3, padding=1)
        self.ra3_conv4 = BasicConv2d(64, classes, kernel_size=3, padding=1)
    ...
    def forward(self, x_):
        x1, x2, x3, x4 = self.base_forward(x_)
...
class aggregation(nn.Module):
    # dense aggregation, it can be replaced by other aggregation previous,
    # such as DSS, amulet, and so on.
    # used after MSF
