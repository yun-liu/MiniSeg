...
from models.baselines.base_model.basic import _ConvBNReLU, InvertedResidual
...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=2, width_mult=1.0, dilated=False, norm_layer=nn.BatchNorm2d):
...
def get_mobilenet_v2(width_mult=1.0, pretrained=False, root='~/.torch/models'):
...
def mobilenet_v2_1_0():
    return get_mobilenet_v2(1.0)


def mobilenet_v2_0_75():
    return get_mobilenet_v2(0.75)


def mobilenet_v2_0_5():
    return get_mobilenet_v2(0.5)


def mobilenet_v2_0_25():
    return get_mobilenet_v2(0.25)
