...
from models.baselines.base_model.basic import _ConvBNReLU, _DWConvBNReLU

__all__ = ['MobileNet', 'get_mobilenet', 'mobilenet1_0', 'mobilenet0_75', 'mobilenet0_5', 'mobilenet0_25']


class MobileNet(nn.Module):
    def __init__(self, num_classes=1000, width_mult=1.0, dilated=False, norm_layer=nn.BatchNorm2d):
...
def get_mobilenet(width_mult=1.0, pretrained=False, root='~/.torch/models'):
...
def mobilenet1_0():
    return get_mobilenet(1.0)


def mobilenet0_75():
    return get_mobilenet(0.75)


def mobilenet0_5():
    return get_mobilenet(0.5)


def mobilenet0_25():
    return get_mobilenet(0.25)
