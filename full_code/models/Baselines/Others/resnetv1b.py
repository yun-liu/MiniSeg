...
def resnet18_v1b(pretrained=False):
...
def resnet50_v1b(pretrained=False):
...
def resnet101_v1b(pretrained=False):
...
def resnet101_v1s(pretrained=False, root='~/.torch/models'):
...
def resnet50_v1s(pretrained=False, root='~/.torch/models'):
...
def resnet152_v1s(pretrained=False, root='~/.torch/models'):
