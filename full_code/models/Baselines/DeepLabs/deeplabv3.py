...
class DeepLabV3(nn.Module):
    def __init__(self, classes=2, aux=True, pretrained_base=True):
        super(DeepLabV3, self).__init__()
        self.pretrained = resnet50_v1b(pretrained=pretrained_base)

        self.head = _DeepLabHead(classes=2)
...
def resnet50_v1b(pretrained=True):
...
class _DeepLabHead(nn.Module):
    def __init__(self, classes=2, norm_layer=nn.BatchNorm2d, norm_kwargs=None):
