...
class ESPNet(nn.Module):
    ...
    def __init__(self, classes=2, aux=True, p=2, q=8, encoderFile=None):
        '''
        ...
        self.combine_l2_l3 = nn.Sequential(BR(2*classes), nn.Conv2d(2*classes , classes, 1, 1, 0), BR(classes))
