...
class MiniSeg(nn.Module):
    def __init__(self, classes=2, P1=2, P2=3, P3=8, P4=6, aux=True):
        ...
        self.pred = nn.Sequential(nn.Dropout2d(0.01, False), nn.Conv2d(64, classes, 1, stride=1, padding=0))
    ...
    def forward(self, input):
        ...
        pred = F.interpolate(self.pred(output4), input.size()[2:], mode='bilinear', align_corners=False)
