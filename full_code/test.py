...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='MiniSeg_h8', help='Model name')
    parser.add_argument('--data_name', default='P20', help='Model name')
    parser.add_argument('--gpu', default=True, type=lambda x: (str(x).lower() == 'true'),
                        help='Run on CPU or GPU. If TRUE, then GPU')
    parser.add_argument('--pretrained', default='./results_MiniSeg_crossVal_mod50/', help='Pretrained model')
